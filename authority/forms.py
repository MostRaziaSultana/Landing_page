...
Banner,Product,BusinessInfo,FrontendSetting,OrderDetails,Feature,FAQ,BillingDetails,FeaturesSection,SiteSettings
)
...
class OrderDetailsForm(forms.ModelForm):
    class Meta:
        model = OrderDetails
        fields = ['product_name', 'product_price', 'quantity', 'subtotal', 'shipping_cost', 'total', 'payment_method', 'date']

class BusinessInfoForm(forms.ModelForm):
    class Meta:
        model = BusinessInfo
        fields = ['company_name', 'phone_no', 'email', 'whatsapp', 'facebook','address']
...
class SiteSettingsForm(forms.ModelForm):
    class Meta:
        model = SiteSettings
        fields = ['site_name', 'gtm_id', 'copyright_year']